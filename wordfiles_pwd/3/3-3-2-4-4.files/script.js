...
var ENDSHOW_MESG="スライド ショーの最後です。 クリックすると終了します。", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=21, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0025.htm", 1, 2),
   new hrefList("slide0003.htm", 1, 3),
   new hrefList("slide0002.htm", 1, 4),
   new hrefList("slide0046.htm", 1, 5),
   new hrefList("slide0047.htm", 1, 6),
   new hrefList("slide0048.htm", 1, 7),
   new hrefList("slide0052.htm", 1, 8),
   new hrefList("slide0053.htm", 1, 9),
   new hrefList("slide0054.htm", 1, 10),
   new hrefList("slide0049.htm", 1, 11),
   new hrefList("slide0050.htm", 1, 12),
   new hrefList("slide0018.htm", 1, 13),
   new hrefList("slide0019.htm", 1, 14),
   new hrefList("slide0006.htm", 1, 15),
   new hrefList("slide0021.htm", 1, 16),
   new hrefList("slide0007.htm", 1, 17),
   new hrefList("slide0008.htm", 1, 18),
   new hrefList("slide0009.htm", 1, 19),
   new hrefList("slide0010.htm", 1, 20),
